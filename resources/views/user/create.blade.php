                                            ...
                                            <div class="row"> <!--First row option starts here-->
                                                <div class="col-sm-6">
                                                    ...
                                                    <div class="form-group"><label class="col-sm-4 control-label">
                                                        ...
                                                        <div class="col-sm-8">
                                                            <select class="select2_demo_user form-control"
                                                            ...
                                                            <div class="alert-danger" >{{$errors->first('user_type')}} </div>
                                                ...
                                                <div class="col-sm-6">
                                                    ...
                                                    <div class="form-group"><label class="col-sm-4 control-label">
                                                        ...
                                                        <div class="col-sm-8">
                                                            <select class="select2_demo_process form-control"

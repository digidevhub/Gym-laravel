                    ...
                    <div class="ibox-content">
                        ...
                        <div class="modal-content">
                            <div class="modal-body">
                                <form method="POST" action="{{route('category.update',['category'=>$category])}} " class="form-horizontal"
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="row">
                                            <div class="col-sm-12">
                                                <h3 class="m-t-none m-b navbar-static-top"> Edit Category Information </h3>
                                            </div>
                                        </div>
                                        <div class="col-sm-12"><h3 class="m-t-none m-b navbar-static-top"></h3>
                                            <div class="row"> <!--First row option starts here-->
                                                <div class="col-sm-10">
                                                    ...
                                                    <!--  Name  -->
                                                    <div class="form-group"><label class="col-sm-4 control-label"> Category Name</label>
                                                        ...
                                                        <div class="col-sm-8">
                                                            <select class="select2_category  form-control"
                                                                ...
                                                                @foreach($processes as $process)
                                                                    ...
                                                                    <option {{ $process->id == $category->process->id ?'selected':""}} value="{{$process->id}}">{{$process->pr_name}}</option>

                                                                @endforeach

                                                            </select>
                                                            <div class="alert-danger" >{{$errors->first('pq_name')}} </div>

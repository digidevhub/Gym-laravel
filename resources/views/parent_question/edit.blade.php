                    ...
                    <div class="ibox-content">
                        ...
                        <div class="modal-content">
                            <div class="modal-body">
                                <form method="POST" action="{{route('parent_question.update',['parent_question'=>$parent_question])}} " class="form-horizontal"
                                                ...
                                                <div class="col-sm-10">
                                                    ...
                                                    <div class="form-group"><label class="col-sm-4 control-label">  Name</label>
                                                        ...
                                                        <div class="col-sm-8"><input type="text"
                                                                                     ...
                                                                                     name="pq_name"
                                                                                     class="form-control"
                                                                                     value="{{ old('pq_name') ?? $parent_question->pq_name }}"
                                                                                     required>
                                                            <div>{{$errors->first('pq_name')}}</div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="form-group"><label class="col-sm-4 control-label">
                                                        ...
                                                        <div class="col-sm-8">
                                                            <select class="select2_demo_pr  form-control"
                                                                    name="process_id" required>
                                                                <option></option>
                                                                @foreach($processes as $process)

                                                                    <option {{ $process->id == $parent_question->process->id ?'selected':""}} value="{{$process->id}}">{{$process->pr_name}}</option>

                                                ...
                                                <div class="col-sm-6">
                                                    ...
                                                    <div class="form-group"><label class="col-sm-4 control-label">Employee  Id</label>
                                                        ...
                                                        <div class="col-sm-8"><input type="text"
                                                                                     ...
                                                                                     name="emp_id"
                                                                                     class="form-control"
                                                                                     value="{{ old('employee_id') ?? $employee->emp_id }}"
                                                                                     required>
...
{{--                                                                    {{dd($tl->id)}}--}}
                                                                    <option {{ $tl->id == $employee->tl->id ?'selected':""}} value="{{$tl->id}}">{{$tl->user_name}}</option>
                                                        ...
                                                        <div class="col-sm-8">
                                                            <select class="select2_qa form-control"
                                                                ...
                                                                @foreach($qa_list as $qa)
                                                                    <option {{ $qa->id == $employee->qa->id ?'selected':""}} value="{{$qa->id}}">{{$qa->user_name}}</option>

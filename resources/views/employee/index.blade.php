            ...
            <div class="col-lg-12">
                ...
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-title">
                        ...
                        <a class="btn-primary pull-right btn-sm" href=" "
                           data-toggle="modal" style="margin-right: 10px;">Import Employee </a>
...
{{--                                        {{dd($employee->tl)}}--}}
                                       ...
                                       {{-- <td> {{$employee->process['pr_name']}} </td>--}}
                                        ...
                                        <td> {{$employee->tl->user_name}} </td>
                                        <td> {{$employee->qa->user_name}} </td>
                                        <td> {{$employee->process->pr_name}} </td>
                                        <td class="center">

                                            <a href="{{route('employee.edit', ['parent_question' => $employee])}} "><i
